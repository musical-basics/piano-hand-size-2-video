...
OUT_FILE="$OUT_DIR/piano_hand_size_part2_rough_cut_v8.mp4"
WORK_DIR="$(mktemp -d /private/tmp/piano-hand-size-rough-cut-v8.XXXXXX)"
...
# Pass 11 restructure: front-facing intro is the FIRST thing the viewer
# sees. It carries the promise of the video; everything else is the
# proof. Order: INTRO → HOOK CARD → 1:42AM SETUP → VO_01.
