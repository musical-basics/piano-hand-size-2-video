...
OUT_FILE="$OUT_DIR/piano_hand_size_part2_rough_cut_v6.mp4"
WORK_DIR="$(mktemp -d /private/tmp/piano-hand-size-rough-cut-v6.XXXXXX)"
SEG_DIR="$WORK_DIR/segments"
CONCAT_FILE="$WORK_DIR/concat.txt"
MUSIC_BED="audio/music/pass8_travel_bed.wav"
...
# VO_01 is now Lionel's real recording (~40s, was ~22s of TTS).
# Montage extended from ~23s to ~40s to match.
start_montage
...
montage_piece_video "footage/02_Drive_To_Titusville/008_IMG_0264_pennsylvania_scenery.MOV" 0 5
montage_piece_video "footage/01_Trip_Setup/004_IMG_0259_sheets_stop_middle_of_nowhere.MOV" 0 5
montage_piece_video "footage/03_David_Factory_Visit/018_IMG_0274_ds_size_lineup_on_steinway.MOV" 49 10 ccw
montage_piece_still "footage/04_Keyboards_Technical_Stills/031_IMG_0287_technical_keyboard_still.JPG" 4 ccw
montage_piece_still "footage/04_Keyboards_Technical_Stills/032_IMG_0288_technical_keyboard_still.JPG" 4 ccw
montage_piece_still "footage/04_Keyboards_Technical_Stills/034_IMG_0290_technical_keyboard_still.JPG" 3 ccw
