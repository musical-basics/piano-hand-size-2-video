...
OUT_FILE="$OUT_DIR/piano_hand_size_part2_rough_cut_v9.mp4"
WORK_DIR="$(mktemp -d /private/tmp/piano-hand-size-rough-cut-v9.XXXXXX)"
...
# VO_01 montage (40s) — Pass 11: NO STILLS. All driving footage so the
# narration sits over motion and feels like a vlog instead of a slideshow.
# Chronological: night drive → gas → sheetz → wake → recovery → morning.
MUSIC_BED="$MUSIC_LATE_NIGHT"
start_montage
montage_piece_video "footage/02_Drive_To_Titusville/010_IMG_0266_drive_broll_2.MOV" 0 9
montage_piece_video "footage/01_Trip_Setup/002_IMG_0257_hagerstown_gas_station.MOV" 7 6 cw
montage_piece_video "footage/01_Trip_Setup/004_IMG_0259_sheets_stop_middle_of_nowhere.MOV" 0 7
montage_piece_video "footage/01_Trip_Setup/005_IMG_0260_waking_up_after_car_nap.MOV" 0 6
montage_piece_video "footage/01_Trip_Setup/006_IMG_0261_car_nap_recovery_drive_resumes.MOV" 0 7
montage_piece_video "footage/02_Drive_To_Titusville/009_IMG_0265_drive_broll_1.MOV" 7 5
